                                            ...
                                            <div class="card-body pt-1">
                                                <form >
                                                    ...
                                                    <div class="form-group d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="text-right"><a href="{{ asset('auth-forgot-password.html') }}" class="card-link">Forgot Password?</a></div>
                                                    </div>
                                                    <a href="{{ asset('auth-register.html') }}" class="btn btn-outline-primary float-left btn-inline">Register</a>
